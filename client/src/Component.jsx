...
import { Rocket, CirclePlay, FileUp, FileText, Sparkles , Brain } from "lucide-react"

export const Component = () => {
    return (
        <div className="w-full  bg-gradient-to-br from-green-100 to-white font-sans px-4 md:px-0 ">
            <header className="py-6 px-8 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    <svg className="w-8 h-8 text-green-600" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
                    </svg>
                    <h1 className="text-xl font-bold text-green-800">StudyGenius</h1>
                </div>
                ...
                <section className="flex flex-col md:flex-row items-center gap-6 md:gap-10 mb-12 md:mb-16">
                    <div className="w-full space-y-4 md:space-y-6">
                        <h2 className="text-4xl md:text-5xl font-bold leading-tight text-green-900">
                            Turn Study Materials into <span className="bg-gradient-to-r from-green-600 to-green-400 bg-clip-text text-transparent">Smart Learning</span> Experiences
                        </h2>
                    ...
                    <div className="w-full md:w-1/2 relative mt-8 md:mt-0">
                        <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-[1.02] transition-all duration-500 border border-gray-100">
                            <div className="bg-green-50 p-4 flex justify-between items-center border-b border-gray-100">
                                ...
                                <div className="text-sm font-medium text-green-700">StudyGenius AI Assistant</div>
                                <div></div>
                            </div>
                            ...
                            <div className="p-6 space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="border-2 border-dashed border-gray-200 rounded-lg p-4 hover:border-green-300 transition-colors duration-300 text-center cursor-pointer">
                                            <FileText className="w-5 h-5 text-gray-400" />
                                            <p className="text-sm text-gray-500">Drag & drop files or <span className="text-green-600">browse</span></p>
                                            <p className="text-xs text-gray-400 mt-1">PDFs, images, or text documents</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4">
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="text-xs text-gray-500">Processing "Biology_101.pdf"</span>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex gap-2 overflow-x-auto pb-2">
                                            <div className="min-w-[120px] bg-white border border-gray-200 rounded-lg p-3 hover:shadow-md transition-all duration-300 cursor-pointer">
                                                <span className="material-symbols-outlined text-green-500 mb-1">summarize</span>
                                                <p className="text-xs font-medium">Summaries</p>
                                            </div>
                                            <div className="min-w-[120px] bg-white border border-gray-200 rounded-lg p-3 hover:shadow-md transition-all duration-300 cursor-pointer">
                                                <span className="material-symbols-outlined text-green-500 mb-1">quiz</span>
                                                <p className="text-xs font-medium">Quizzes</p>
                                            </div>
                                            <div className="min-w-[120px] bg-white border border-gray-200 rounded-lg p-3 hover:shadow-md transition-all duration-300 cursor-pointer">
                                                <span className="material-symbols-outlined text-green-500 mb-1">style</span>
